    ...
    return (
      <div className="w-full">
        ...
        <input
          ...
          id={inputId}
          className={cn(
            "flex h-10 w-full rounded-lg border border-theme-accent2 dark:border-gray-600 bg-theme-primaryBackground dark:bg-darkBlue-003 px-3 py-2 text-sm text-theme-primaryText dark:text-white",
            "ring-offset-white file:border-0 file:bg-transparent file:text-sm file:font-medium",
            "placeholder:text-theme-accent4 dark:placeholder:text-gray-400",
